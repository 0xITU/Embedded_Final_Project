...
# module references:
# ram_out_selector, ram_selector, top
...
proc create_root_design { parentCell } {
  ...
  set interrupt [ create_bd_port -dir I -type intr interrupt ]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins ram_out_selector_0/clk] [get_bd_pins ram_selector_0/clk] [get_bd_pins top_0/clk]
  ...
  connect_bd_net -net top_0_read_strobe [get_bd_pins ram_out_selector_0/read_strobe] [get_bd_pins top_0/read_strobe]
